...
## Decision — v0.1.103.10.38 API coverage semantic assertions
...
## Decision — v0.1.103.10.38 pb test api service config token
...
## Decision — v0.1.103.10.38 source-add auth preflight may accept project page readiness
...
### v0.1.103.10.38 — pre_tests auth bootstrap must prefer current conversation scope
