...
active candidate: chatgpt_claudecode_workflow-2_v0.1.103.10.32.zip
active candidate version: v0.1.103.10.32
next normal target: chatgpt_claudecode_workflow-2_v0.1.103.10.32.zip
next normal slice: v0.1.103.10.32 — full/browser validation skips generic-root login check
