...
active candidate: chatgpt_claudecode_workflow-2_v0.1.103.10.33.zip
active candidate version: v0.1.103.10.33
next normal target: chatgpt_claudecode_workflow-2_v0.1.103.10.33.zip
next normal slice: v0.1.103.10.33 — release-control auth bootstrap before live operations
