...
active candidate: chatgpt_claudecode_workflow-2_v0.1.103.10.3.zip
active candidate version: v0.1.103.10.3
next normal target: chatgpt_claudecode_workflow-2_v0.1.103.10.3.zip
next normal slice: v0.1.103.10.3 — Bonnetjes auth-only release-control path
...
## v0.1.103.10.3 — Bonnetjes auth-only release-control path

Artifact: chatgpt_claudecode_workflow-2_v0.1.103.10.3.zip
