...
| v0.1.70 | normal | Multi-repo artifact registry state | candidate | focused artifact/state/CLI tests; project control-surface test; compileall; ZIP hygiene; full tests not run here | DOD-014 added/done after focused validation; DOD-009 done after ZIP hygiene; DOD-011 remains open until adoption evidence | pending adoption evidence |
