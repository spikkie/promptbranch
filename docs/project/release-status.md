...
| v0.1.99 | normal | Rolling slice horizon and architecture-decision protocol | candidate | focused control-surface/next-slice/CLI validation pending full release-control/adoption | DOD-133 focused; first command execution deferred to v0.1.100 | pending adoption evidence for `chatgpt_claudecode_workflow-2_v0.1.99.zip` |
