...
| v0.1.84.5.11 | normal | Live validation diagnostics and source-add timeout observability | candidate | fast fixture diagnostics tests, ask-live recovered classifier regressions, version/control-surface tests, bash syntax, py_compile, Artifact Guardian before operator full run-all/adopt | DOD-100 focused; builds from accepted/current v0.1.84.5.10.3 | pending adoption evidence |
