...
| v0.1.98 | normal | Plan authority and anti-drift control-surface gate | candidate | focused project-control/plan-state/CLI validation, version tests, compileall, shell syntax, Artifact Guardian, ZIP hygiene; full release-control/adoption pending | DOD-132 focused; first command execution deferred to v0.1.99 | pending adoption evidence for `chatgpt_claudecode_workflow-2_v0.1.98.zip` |
