...
| DOD-180 | release-live challenge fail-fast logging is structured and does not cascade live steps | in_progress | `promptbranch_browser_auth/client.py`; `chatgpt_browser_auth/client.py`; `chatgpt_claudecode_workflow_release_control.sh`; focused shell-script tests | v0.1.103.10.44 |
