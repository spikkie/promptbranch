...
## Active repair horizon — v0.1.103.10.64

`v0.1.103.10.64` remains in the Docker/Patchright release-live repair line. It does not introduce host-CDP/session-manager, copied profile trust, or Cloudflare workarounds.
