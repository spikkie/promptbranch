...
|---|---|---|---|---|
| v0.1.103.10.47 | make docker_live_profile_challenged terminal for live test matrix and release-control | active | Stop ask-live and later live browser steps immediately after a challenged Docker live slot | host-CDP/session-manager, copied-profile trust, browser architecture redesign, Project deletion |
