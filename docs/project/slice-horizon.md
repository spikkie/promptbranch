...
## Active repair — v0.1.103.10.26

`v0.1.103.10.26 — pb test api reads service config token`: enforce response-body semantic success checks in the API coverage runner; no browser/session architecture changes.
