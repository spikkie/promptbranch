...
## Active repair — v0.1.103.10.34

`v0.1.103.10.34 — release-control auth bootstrap before live operations`: enforce response-body semantic success checks in the API coverage runner; no browser/session architecture changes.
