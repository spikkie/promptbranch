...
## Active repair — v0.1.103.10.27

`v0.1.103.10.27 — repair /v1/ask submit causality endpoint path`: enforce response-body semantic success checks in the API coverage runner; no browser/session architecture changes.
