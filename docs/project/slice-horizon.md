...
|---|---|---|---|---|
| v0.1.103.5 | Docker parity true keep-open browser session mode | active | Wire passive auth readiness into the actual Promptbranch browser client used by the service | Project Source mutation, deployment, artifact adoption |
...
## v0.1.103.5 active repair horizon

`v0.1.103.5` is the active Docker parity repair horizon. It gates Project Source mutation behind passive auth-readiness, profile writability, and explicit `PROMPTBRANCH_ALLOW_PROJECT_SOURCE_MUTATION=1`.
