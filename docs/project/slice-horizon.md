...
|---|---|---|---|---|
| v0.1.103.9 | Bonnetjes Cloudflare parity profile hygiene | active | Lock in clean logged-in Bonnetjes profile testing, build-context exclusions, and safe no-artifact evidence export | Project Source mutation, deployment, artifact adoption |
