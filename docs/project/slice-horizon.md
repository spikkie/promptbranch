...
|---|---|---|---|---|
| v0.1.103.10 | Bonnetjes Cloudflare one-shot validation script | active | One operator validation workflow for install, clean visible login profile bootstrap, Docker Bonnetjes Cloudflare parity check, and strict auth-ready validation | Project Source mutation, deployment, artifact adoption |
...
## v0.1.103.10 active repair horizon

`v0.1.103.10` is the active Docker parity repair horizon for the Bonnetjes Cloudflare one-shot validation script. It remains candidate-only and keeps Project Source mutation out of scope.
