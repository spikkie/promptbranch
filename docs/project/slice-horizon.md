...
## Active repair — v0.1.103.10.29

`v0.1.103.10.29 — expose or auto-handle compatible held auth session in pb test api`: enforce response-body semantic success checks in the API coverage runner; no browser/session architecture changes.
