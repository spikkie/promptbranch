...
active candidate: chatgpt_claudecode_workflow-2_v0.1.103.10.28.zip
active candidate version: v0.1.103.10.28
next normal target: chatgpt_claudecode_workflow-2_v0.1.103.10.28.zip
next normal slice: v0.1.103.10.28 — repair pb test api ask conversation target
