...
active candidate: chatgpt_claudecode_workflow-2_v0.1.103.10.34.zip
active candidate version: v0.1.103.10.34
next normal target: chatgpt_claudecode_workflow-2_v0.1.103.10.34.zip
next normal slice: v0.1.103.10.34 — release-control auth bootstrap before live operations
