...
active candidate: chatgpt_claudecode_workflow-2_v0.1.103.10.51.zip
active candidate version: v0.1.103.10.51
next normal target: chatgpt_claudecode_workflow-2_v0.1.103.10.51.zip
next normal slice: v0.1.103.10.51 — versioned Docker image tag propagation for parity/check compose paths
