...
latest created ZIP: chatgpt_claudecode_workflow-2_v0.1.103.10.77.zip candidate once packaged
release status: v0.1.103.10.77 is a repair candidate until full all-all release-control/adoption evidence proves accepted/current alignment
...
```text
Validate and package v0.1.103.10.77 as the active repair candidate from the last accepted/current operational baseline.
```

Operator promotion command after candidate ZIP creation:

```bash
./install.sh v0.1.103.10.77
```
