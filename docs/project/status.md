...
active candidate: chatgpt_claudecode_workflow-2_v0.1.103.10.50.zip
active candidate version: v0.1.103.10.50
next normal target: chatgpt_claudecode_workflow-2_v0.1.103.10.50.zip
next normal slice: v0.1.103.10.50 — auth bootstrap backend-api 403 guardrail is terminal
