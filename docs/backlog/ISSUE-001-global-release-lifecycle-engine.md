...
- [x] Same-run pipeline adoption is bound to exact Project Source evidence.
- [x] Cross-invocation evidence import validates immutable repository, version, artifact, Git, contract and source bindings without mutation.
...
- [x] Every pipeline phase updates an incremental checkpoint; guarded resume records imported provenance and does not replay successful mutation phases.
