...
def _coerce_controlled_process_flag(
    ...
    """Normalize the v0.0.160 controlled-process flag.
...
def inspect_local_context(
    *,
    ...
    payload = {
        ...
        "ollama": {
            "enabled": False,
            "reason": "v0.0.160 keeps tool planning deterministic; Ollama is optional and may be used only for summaries/diagnostics.",
        },
    }
    return payload
