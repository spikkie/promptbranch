...
usage() {
  cat <<USAGE
Usage:
  $(basename "$0") --version v0.0.189 [options]
  $(basename "$0") v0.0.189 [options]

Options:
  -v, --version VERSION       Highest-precedence release version override.
                              Accepts v0.0.189, 0.0.189, or ${project_name}_v0.0.189.zip.
...
ver="$(normalize_version "${version_arg}")" || fail "version must look like v0.0.189, 0.0.189, or ${project_name}_v0.0.189.zip; got '${version_arg}'"
ver_plain="${ver#v}"
