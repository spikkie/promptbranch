...
def test_version_tag_does_not_double_prefix_current_release() -> None:
    assert promptbranch_version.PACKAGE_VERSION == "0.1.77.1"
    assert promptbranch_version.VERSION_TAG == "v0.1.77.1"
    assert promptbranch_version.VERSION_TAG != "vv0.1.77.1"
