...
def test_v01041_through_v01044_force_fresh_direct_and_independent_localhost() -> None:
    assert 'if [[ "${ver}" == "v0.1.104.1" || "${ver}" == "v0.1.104.2" || "${ver}" == "v0.1.104.3" || "${ver}" == "v0.1.104.4" ]]' in SCRIPT
